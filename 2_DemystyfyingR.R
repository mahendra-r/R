...
# 7 names that have a 'type' of character. 

# The arrow-like '<-' symbol is the assignment operator in R, similar to the
# equal sign '=' in other programming languages. 
# The c() is a generic function that combines arguments, in this case the
